      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-24">
          <div className="inline-block relative">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-7xl font-black text-gray-900 mb-6 tracking-tight">
          ...
          <p className="text-gray-600 text-base sm:text-lg lg:text-xl max-w-2xl mx-auto mt-8 font-semibold leading-relaxed">
          ...
          <div className="space-y-8 lg:space-y-12">
            <div className="relative group">
              ...
              <div className="relative bg-white rounded-[2.5rem] p-6 sm:p-8 lg:p-10 border border-gray-100 shadow-sm overflow-hidden">
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-6 tracking-tight relative">Direct Connection</h2>
                <p className="text-gray-500 text-sm sm:text-base font-semibold mb-8 lg:mb-10 relative">
                ...
                <div className="space-y-4 sm:space-y-6 relative">
                  {contactInfo.map((info, index) => (
                    <div
                      key={index}
                      className="group/card bg-gray-50/50 hover:bg-white p-4 sm:p-6 rounded-2xl border border-transparent hover:border-blue-100 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300"
                    >
                      <div className="flex items-center gap-4 sm:gap-6">
                        <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-2xl shadow-sm text-blue-600 transform group-hover/card:scale-110 group-hover/card:rotate-6 transition-all duration-300 shrink-0">
                          {info.icon}
                        </div>
                        <div className="min-w-0 flex-1">
                          ...
                          {info.link ? (
                            <a
                              href={info.link}
                              className="text-sm sm:text-base lg:text-lg font-black text-gray-900 hover:text-blue-600 transition-colors break-all"
                            >
                              {info.value}
                            </a>
                          ) : (
                            <span className="text-sm sm:text-base lg:text-lg font-black text-gray-900">{info.value}</span>
                          )}
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-gray-900 rounded-[2.5rem] p-6 sm:p-8 lg:p-10 text-white relative overflow-hidden group">
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 relative">
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${social.gradient} rounded-2xl flex items-center justify-center p-3 sm:p-4 shadow-lg group-hover/social:shadow-2xl transition-all duration-300`}>
                      <div className="text-white transform group-hover/social:scale-110 transition-transform">
                        {social.icon}
                      </div>
                    </div>
                    <span className="text-[10px] sm:text-xs font-bold text-gray-400 group-hover/social:text-white transition-colors uppercase tracking-widest">{social.name}</span>
                  </a>
                ))}
              </div>
            </div>
