...
// //                   <span>{tab.name}</span>
// //                   {activeTab === tab.name && (
// //                     <div className="ml-auto w-2 h-2 bg-blue-500 rounded-full animate-pulse group-hover:bg-blue-500" />
// //                   )}
// //                   <div
// //                     className={`absolute left-0 top-0 w-1 h-full bg-blue-500 transition-transform duration-1000 ${
...
//       {isMenuVisible && (
//         <div className="md:hidden fixed inset-0 z-40 bg-white/5 bg-opacity-50 backdrop-blur-">
//           <div
//             className={`mobile-menu-container fixed top-14 left-0 w-64 bg-white rounded-br-2xl shadow-xl transition-all duration-1000 ease-in-out transform ${
//               isAnimating && isMenuOpen
//                 ? "translate-x-0 opacity-100"
...
//                   className={`relative flex items-center text-sm sm:text-base font-semibold transition-all duration-1000 transform hover:scale-105 group ${
//                     activeTab === tab.name
//                       ? "text-black bg-blue-500 rounded-r-2xl"
